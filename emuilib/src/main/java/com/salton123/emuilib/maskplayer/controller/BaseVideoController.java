...
public abstract class BaseVideoController extends FrameLayout {
    ...
    protected IPlayerControl mediaPlayer;//播放器
    ...
    public void setPlayState(int playState) {
        ...
        switch (playState) {
            case MaskVideoView.STATE_ERROR:
                break;
        }
    }
    ...
    protected void doPauseResume() {
        if (currentPlayState == MaskVideoView.STATE_BUFFERING) return;
    ...
    public void setMediaPlayer(IPlayerControl mediaPlayer) {
