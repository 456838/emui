...
import com.salton123.emuilib.util.ProgressUtil;
...
public abstract class BasicVideoView extends FrameLayout implements IPlayerControl, PlayerEventListener {
    ...
    public BasicVideoView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BasicVideoView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void onPrepared() {
        ...
        if (mCurrentPosition > 0) {
            MLog.d("seek to:" + mCurrentPosition);
