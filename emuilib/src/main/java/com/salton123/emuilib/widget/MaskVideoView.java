...
public class MaskVideoView extends BasicVideoView {
    ...
    public MaskVideoView(@NonNull Context context) {
        this(context, null);
    }

    public MaskVideoView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MaskVideoView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
